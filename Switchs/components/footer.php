...
<footer class="footer">
    <div class="footer-container">
        ...
        <div class="footer-box">
            ...
            <div class="redsocial">
                ...
                <a href="https://twitter.com/akkogear_de?ref=12e4z440" target="_blank" class="fa-brands fa-twitter"></a>
    ...
    <div class="footer-bottom">
        <small>&copy; <?php echo date("Y"); ?> <b>Switch's</b> - Todos los Derechos Reservados.</small>
    </div>
</footer>
